...
const ModalFilterOmset = ({ filterCabang, setFilterCabang, setDataFilterOmset, dataFilterOmset, handleTerapkanFilter, resetFilterOmset }) => {
  ...
  useEffect(() => {
    ...
    setTitleCard('Filter Omset Biaya')
...
export default ModalFilterOmset