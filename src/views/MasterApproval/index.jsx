...
import TableMasterApproval from './components/TableMasterApproval';
        ...
        <div className='flex sm:flex-row flex-col gap-5'>
          <div className='flex gap-3 w-full items-center'>
            ...
            <div className='flex flex-col gap-1'>
              <div className='text-xl font-bold text-blue-900'>Flow Approval</div>
              <div className='text-sm font-light'>
                Lihat data flow approval disini.
              </div>
            </div>
          </div>
          <div className='flex sm:w-full justify-end'>
                            ...
                            >Download Report</button> */}
            {
              ...
              <button className='btn bg-blue-900 text-white rounded-[25px] px-5 hover:scale-105' onClick={() => navigation('/add-master-approval', { state: { ...location.state, project: 'Add Flow Approval' } })}><FaPlusCircle className='' /> Tambah Flow Approval</button>
              // )
            }
          </div>
        </div>
