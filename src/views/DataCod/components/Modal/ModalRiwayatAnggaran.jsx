...
const ModalRiwayatAnggaran = () => {
  ...
  const headerData = {
    ...
    anggaran_terpakai: toggleModal?.data?.realisasi_biaya,
    sisa_anggaran: toggleModal?.data?.sisa_anggaran
  }
          ...
          <div className="flex items-center justify-between mb-4 flex-wrap gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500">
                Total Riwayat : {toggleModal?.data?.history?.length}
              </p>
            </div>
            <button
              onClick={exportExcel}
                        ...
                        <td>
                          {item?.nominal_penambahan && (
                            ...
                            "
                              >
                                ...
                                <div>
                                  ...
                                  <div className="font-bold text-green-700">
                                    {formatCurrency(item.nominal_penambahan)}
                                  </div>
                              ...
                              <div
                                className="
                              inline-flex max-w-xs items-start gap-3
                              bg-green-50
                            ...
                            "
                              >
                                ...
                                <FaTag className="text-slate-600 text-lg mt-0.5" />
                              ...
                              >
                                ...
                                <div>
                                  ...
                                  <div className="font-bold text-red-700">
                                    {formatCurrency(item.nominal_pemakaian)}
                                  </div>
