...
import { FaBuilding, FaFileAlt, FaHashtag, FaListAlt, FaMoneyBillWave, FaTimesCircle, FaUser, FaUserTag } from 'react-icons/fa';
import { GrClose } from 'react-icons/gr';
import { formatCurrency } from 'global/helper/formatCurrency';

const ModalReject = (onClick) => {
        ...
        <>
          <div className="flex justify-end gap-2">
            ...
            <button
              ...
              className={`btn px-4 py-2 rounded-full text-white flex items-center gap-2 ${"bg-red-500 hover:bg-red-600 disabled:bg-red-300"
                }`}
            >
              <>
                <FaTimesCircle /> Ya, Tolak
              </>
            </button>
          </div>
        </>
      ...
      <div>
        ...
        <div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-0 text-xs">
            ...
            {[
              ...
              <div
                key={index}
                className="flex items-center gap-4 p-3 rounded-xl shadow-md border border-red-200 hover:shadow-lg shadow-red-200 transition bg-gray-50"
              >
                {/* Icon */}
            ...
            <div className="col-span-1 md:col-span-3 flex items-start gap-4 p-3 rounded-xl shadow-md shadow-red-200 border border-red-200 bg-gray-50">
              {/* Icon */}
              <div className="min-w-8 min-h-8 flex items-center justify-center rounded-xl bg-blue-100 text-blue-900 text-lg shadow-sm">
                <FaFileAlt />
              </div>
        ...
        <div className="mt-5">
          ...
          <div className="mt-3 flex gap-3 overflow-x-auto pb-2">
            {[
              ...
              <div
                key={index}
                className="min-w-[180px] flex items-center gap-3 p-3 rounded-xl border border-red-200 bg-white shadow-sm hover:shadow-md transition cursor-pointer"
        ...
        <div className="mb-4 mt-5">
          ...
          <textarea
            ...
            className={`w-full mt-2 p-3 border rounded-lg outline-none focus:ring-2 text-sm ${"focus:ring-red-400 border-red-300"
              }`}
            maxLength={500}
          />
