...
import TabDokumen from '../TabDokumenModalAkselerasi';

const ProjectAkselerasi = ({ location, data, getDetailProject, isDetailModalAkselerasi, isVendorRealization, isBillingRealization }) => {
  ...
  return (
    <>
      ...
      >
        ...
        <TabDokumen isDetailModalAkselerasi={true} data={toggleModal?.dataDetailAkselerasi} customer={toggleModal?.customer} getDetailProject={getDetailProject} />
      </Modal>
