...
// COMPONENT
// =========================
const TableJenisPajak = ({ dimensionScreenW, check, loginAccess }) => {
  ...
  const headerTable = [
    ...
    { label: "No", icon: <FaDatabase /> },

    { label: "Jenis Jasa", icon: <FaDatabase /> },

    { label: "Kode Objek", icon: <FaInfoCircle /> },

    { label: "Jenis PPh", icon: <FaInfoCircle /> },

    { label: "Tarif (%)", icon: <FaPercent /> },
  ];

  const getListJenisPajak = async () => {
    try {
      setAllData([])
      setLoading(true);
...
export default TableJenisPajak;