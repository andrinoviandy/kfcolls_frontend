...
// ICONS Fa / Io
import { FaTachometerAlt, FaFileAlt, FaChartBar, FaDatabase, FaBook, FaUserAlt, FaUserCheck, FaUsersCog, FaWallet, FaCalculator, FaReceipt, FaFileInvoiceDollar, FaCheckDouble } from "react-icons/fa";
...
const Sidebar = () => {
  ...
  //     submenu: [],
  //   },
  //   // ...(['RL05', 'RL00'].includes(loginAccess?.role_id) ? [{
  //   //   id: 1,
  ...
  //     icon: FaFileAlt,
  //     submenu: [
  //       ...(['RL01', 'RL00'].includes(loginAccess?.role_id) ? [
  //         {
  //           name: "Data Pengajuan",
  //           path: "/data-pengajuan",
  //         },
  ...
  //       },
  //       // ...(!['RL00'].includes(loginAccess?.role_id) ? [
  //       //   {
  //       //     name: "Flow Approval",
  //       //     path: "/flow-approval",
  //       //   },
  ...
  //     ],
  //   },
  //   ...(['RL00', 'RL06'].includes(loginAccess?.role_id) ? [
  //     {
  //       id: 3,
  ...
  //     {
  //       id: 5,
  //       name: ['RL08', 'RL00'].includes(loginAccess?.role_id) ? "Manajemen Anggaran" : "Riwayat Anggaran",
  ...
  const menuList = dummyMenu
    ...
    .filter((menu) => {
      // Kalau punya submenu, tampilkan jika masih ada submenu
      if (menu.submenu?.length > 0) {
        return menu.submenu.length > 0;
      }

      // Kalau tidak punya roles berarti bebas
      if (!menu.roles) return true;

      return menu.roles.includes(loginAccess?.role_id);
    });
